...
/**
 * Created by omar on 18/06/17.
 */

public class NearToMeChurchMapActivity
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        for (Institution institution: listInstitution){
            sydney = new LatLng( Double.parseDouble(institution.getLatitude()) ,Double.parseDouble(institution.getLongitude()) );
